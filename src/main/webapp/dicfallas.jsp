...
<head>
<meta charset="UTF-8">
<title>Diccionario Fallas</title>
...
<body >
<section id="cta" class="Hoja estilo6">
      <div class="contacto">
        <div class="padre">
          <div class="hijo">
            <h2 id="titulo6">
              Gracias por mandar tu reporte, esta falla será revisada y atendida lo antes posible.
            </h2>
            <div class="tel">
          ...
          <div class="padre1">
            <div aria-label="Consulta-Medios" id="FormularioInicioSesion">
              ...
              <form id="FormularioInicioSesion"  action="ServletFallas?accion=GUARDAR" method="POST">
                <div>
                  ...
                  <div class="mb-3 form-group">
                    <div>
                      <div class="flex flex-col"><label class="form-label" for="apellido">Nombre de Usuario</label>
                        <div class="caja">
                          <input type="text" class="form-control w-full py-3 px-2 text-xl  border-b border-teal-500" id="lastname" name=" apellido">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div>
                    <div>
                      <div class="flex flex-col form-group"><label class="form-label"  for="mensaje">Descripción de la falla...</label>
